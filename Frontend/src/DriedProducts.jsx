...
export default function DriedProducts() {
  const [products, setProducts] = useState([]);
   const navigate = useNavigate(); // ✅ create navigate function

  useEffect(() => {
    fetch(process.env.REACT_APP_API_URL + `/products?category=dried`)
      .then(res => res.json())
