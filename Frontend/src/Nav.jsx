...
import img1 from './images/ChatGPT_Image_Oct_16__2025__08_46_08_PM-removebg-preview.png';
import {
  FaTwitter, FaFacebook, FaPinterest, FaInstagram, FaEnvelope,
  FaShoppingCart, FaSearch, FaBars, FaPhoneSquare, FaMapMarker, FaUserCircle
} from 'react-icons/fa';
    ...
    <div className='nav2'>
      <Row className="rw1 ">
        <Col xs={12}>
          <Container>
            <div className="d-flex justify-content-between align-items-center nine">
              <img src={img1} alt="Logo" title="Fesho" className="img1" />
              <Navbar expand="lg" className="nav-outer nav1">
                <Navbar.Toggle aria-controls="navbar-nav" className="nav2" />
                <Navbar.Collapse id="navbar-nav">
                  <Nav className="ml-auto">
                    ...
                    <Nav.Link as={NavLink} to="/contact" className={({ isActive }) => (isActive ? 'link1 active' : 'link1')}>
                      Contact
                    </Nav.Link>
                  </Nav>
                </Navbar.Collapse>
              ...
              {cartItems.length > 0 && (
                <>
                  ...
                  {user ? (
                    ...
                    <Link to="/login">
                      <Button variant="warning" onClick={() => setShowCartModal(false)}>
                        Login to Checkout
                      </Button>
                    </Link>
                  )}
          ...
          <Modal show={showProfileModal} onHide={() => setShowProfileModal(false)} centered className="profile-modal">
            ...
            <Modal.Body>
              {user ? (
                <>
                  <FaUserCircle style={{ fontSize: '60px', color: '#43aa5c' }} />
          ...
          <Offcanvas.Body>
            <Nav className="flex-column">
              ...
              <NavDropdown title="Shop" id="shop-dropdown" className="custom-dropdown">
                <NavDropdown.Item as={Link} to="/shop">Products</NavDropdown.Item>
            ...
            <div className="div1">
              <ul className="li3">
                <li>
                  <FaPhoneSquare style={{ fontSize: '20px', color: '#43aa5c', marginRight: '15px' }} />
                  <span>+91 6380962804</span>
                </li>
                <li>
                  <FaEnvelope style={{ fontSize: '20px', color: '#43aa5c', marginRight: '15px' }} />
                  <span>Organic@company.com</span>
                </li>
                <li>
                  <FaMapMarker style={{ fontSize: '19px', color: '#43aa5c', marginRight: '15px' }} />
                  <span>66 Road, GP Street, Coimbatore</span>
                </li>
              </ul>
            </div>
